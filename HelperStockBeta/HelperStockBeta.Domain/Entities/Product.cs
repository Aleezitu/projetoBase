...
namespace HelperStockBeta.Domain.Entities
{
    public sealed class Product : Entity
    {
        ...
        private void ValidationDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(name.Length < 3, "Invalid short name minimus 3 characteres");
            DomainExceptionValidation.When(string.IsNullOrEmpty(description), "Invalid description, is required.");
            DomainExceptionValidation.When(description.Length < 5, "Invalid short description, minimus 5 characteres.");
            ...
            DomainExceptionValidation.When(image.Length < 250, "Invalid long URL, maximum 250 characteres.");
            Name = name;
